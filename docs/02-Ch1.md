# Topic 1: GNI per capita across countries and over time



This document uses data on GNI per capita (PPP)[^1] from the [World Bank's World Development Indicators database](https://datacatalog.worldbank.org/search/dataset/0037712/World-Development-Indicators) to provide examples of representing data. 
...
```r
data <- read_excel("data_ch1.xlsx", sheet = "gnipcppp_wide_small")
...
```
we see that it is classified as `character` (meaning text or string) which means that R does not recognise that three of the countries are from the same region. In such situations, it is important to explicitly tell R that the variable is categorical. In R, categorical varialbes are referred to as factor variables. We can declare the variable to be categorical as follows: 
...
```r
rm(cs.data, data, long.data, ts.data)
```
...
[^2]: The function `kable()` is used here to format the tables better for the document. You can obtain the same information by simply using `summary(csdata$Region)` instead of `ktable(summary(csdata$Region))`, but will be formatted slightly differently - feel free to try.
...
```
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
##     230    2195    6435   15890   19692  117280      16
```
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-15-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-16-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-19-1.png)<!-- -->

While the R's base in-built library for graphs `graphics` is sufficiently extensive (you can find more about it [here](https://www.rdocumentation.org/packages/graphics/versions/3.6.2)), for the remainder of this document we will make use of the more advanced and customizable library `ggplot2` (more [here](https://ggplot2.tidyverse.org/)). 
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-20-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-21-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-24-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-25-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-26-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-27-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-29-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-30-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-32-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-33-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-39-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-40-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-43-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-44-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-45-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-46-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-49-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-53-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-54-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-55-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-58-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-59-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-61-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-64-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-65-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-66-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-67-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-71-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-72-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-73-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-77-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-78-1.png)<!-- -->
...
![](02-Ch1_files/figure-epub3/unnamed-chunk-80-1.png)<!-- -->
